...
ActiveRecord::Schema.define(version: 20180302171325) do
  ...
  create_table "candidates_events", force: :cascade do |t|
  ...
  add_index "mail_server_emails", ["deleted_at"], name: "index_mail_server_emails_on_deleted_at", using: :btree
  ...
  add_index "user_scores", ["deleted_at"], name: "index_user_scores_on_deleted_at", using: :btree
  ...
  add_index "working_times", ["deleted_at"], name: "index_working_times_on_deleted_at", using: :btree
